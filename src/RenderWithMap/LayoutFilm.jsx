...
export default class LayoutFilm extends Component {
  renderCardFilm = () => {
    return data.map((film, index) => {
      return (
        <div className="col-lg-2 col-md-3 mt-2" key={index}>
          <div className="card">
            <img src={film.hinhAnh} alt="..." height={350} />
            <div className="card-body bg-dark text-white">
              <h3 style={{ height: 100 }}>{film.tenPhim}</h3>
              <p style={{ height: 75 }}>
                {film.moTa.length > 100 // nếu độ dài mota lớn hơn 100 ký tự
                  ? film.moTa.slice(0, 100) + "..." // thì + thêm ... còn nếu ko thì giữ nguyên
                  : film.moTa}
              </p>
            </div>
          </div>
        ...
        <div className="bg-films">
          ...
          >
            <nav
              ...
              style={{ background: "rgba(255,0,255,.2)" }}
            >
